  ...
  const renderTreatmentsTable = () => (
    <>
      <div style={{
        ...
        {Object.entries(groupedTreatments).map(([date, dateTreatments]) => (
          <div key={date} style={{ marginBottom: '32px' }}>
            <div style={{
              ...
              <div style={{
                ...
                {dateTreatments.length} treatment{dateTreatments.length !== 1 ? 's' : ''}
              </div>
            </div>
                  ...
                  return (
                    <tr key={treatment.id} style={{
                      ...
                      <td style={{
                        ...
                        color: '#4b5563',
                        verticalAlign: 'top'
                      }}>{treatment.in_dialysate || 'N/A'}</td>
                      <td style={{
                        padding: '12px 16px',
                        color: '#4b5563',
                        verticalAlign: 'top'
                      }}>{treatment.bagSerialNumber || 'N/A'}</td>
                      <td style={{
                        padding: '12px 16px',
                        color: '#4b5563',
                        verticalAlign: 'top'
          ...
          <form onSubmit={handleSearch} style={{ marginBottom: '24px' }}>
            <div style={{
              ...
              <div style={{ position: 'relative', flex: 1 }}>
                ...
                <input
                  type="text"
                  placeholder="Search treatments by dialysate, bag serial, notes..."
                  style={{
                    width: '100%',
