...
import { 
  ...
  FaCalendarCheck, FaFilePdf, FaShieldAlt
} from 'react-icons/fa';
...
const StaffOutpatientDetailsForm = () => {
  ...
  useEffect(() => {
    const fetchAvailableDates = async () => {
      try {
        ...
        // Inside the fetchAvailableDates function
    ...
    switch (name) {
      ...
      case 'phone_number':
        ...
        if (phoneDigits.length !== 11 || !phoneDigits.startsWith('09')) {
          newErrors.phone_number = 'Please enter a valid Philippine mobile number (09xx-xxx-xxxx, 11 digits)';
        } else {
  ...
  const validateForm = () => {
    const requiredFields = [
      ...
      'phone_number', 'appointment_date', 'legalRepresentative'
    ];
          ...
          <form onSubmit={handleFormSubmit}>
            ...
            <div style={{ marginBottom: '30px' }}>
              ...
              <p style={{ color: '#666', marginBottom: '15px' }}>
                Please fill in all required details for the new outpatient. Fields marked with <span style={{ color: 'red' }}>*</span> are mandatory.
              </p>
              ...
              <div style={{ 
                ...
                <div>
                  <label style={{ 
                    ...
                    <FaPhone style={{ marginRight: '8px', color: '#638ECB' }} />
