...
const StaffOutpatientEmailVerification = () => {
  ...
  return (
    <div style={{
      ...
      marginTop: isMobile ? '-400px' : '-890px',
    }}>
      {/* Notification Center */}
      <div style={{
        position: 'fixed',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{
              ...
              <FaUserPlus /> Register New Outpatient
            </h2>
            <div style={{
              display: 'flex',
              alignItems: 'center',
                ...
                <form onSubmit={handleVerificationSubmit} style={{
                  ...
                  <div style={{
                    ...
                    <p style={{
                      ...
                      <strong> This will be used for important communications like appointment reminders and test results.</strong>
                    </p>
                  </div>
                  ...
                  <div style={{
                    ...
                    <label htmlFor="email" style={{
                      ...
                      Patient Email Address <span style={{ color: '#ef4444' }}>*</span>
                    </label>
                    <input
                      type="email"
                      id="email"
