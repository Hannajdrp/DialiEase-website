...
import UpcomingScheduleOverview from './UpcomingScheduleOverview';
...
const DoctorDashboard = () => {
  ...
  if (loading) {
    return <S.LoadingContainer>
      <S.LoadingSpinner />
      <S.LoadingText>
        Good Day Doc, wait for a seconds!<S.LoadingDots>...</S.LoadingDots>
      </S.LoadingText>
    </S.LoadingContainer>;
  }
    ...
    <S.DashboardContainer>
      ...
      <S.MainContent>
        ...
        <UpcomingScheduleOverview
          ...
          filteredTomorrowPatients={filteredTomorrowPatients}
          tomorrowSearchTerm={tomorrowSearchTerm}
          setTomorrowSearchTerm={setTomorrowSearchTerm}
          filteredNextWeekPatients={filteredNextWeekPatients}
