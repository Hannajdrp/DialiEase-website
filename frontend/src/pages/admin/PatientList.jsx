...
const PatientList = () => {
  ...
  const handleVideoCall = (email) => {
    if (email) {
      const meetUrl = `https://meet.google.com/new?hs=191&authuser=0&email=${encodeURIComponent(email)}`;
  ...
  const handleBatchCall = () => {
    const phoneNumbers = selectedPatients
      .map(id => {
    ...
    if (phoneNumbers.length > 0) {
      ...
      alert('No phone numbers available for selected patients');
    }
  };
            ...
            <table style={styles.table}>
              <thead>
                <tr style={styles.tr}>
                  ...
                  <th style={styles.th}>Patient Journey</th>
