...
// Color variables (matching StaffSidebar)
const colors = {
  primary: '#395886',
  white: '#FFFFFF',
  green: '#477977',
...
const AdminSidebar = ({ user }) => {
  ...
  const menuItems = [
    ...
    { 
      ...
      match: "PatientList",
      subItems: [
        { name: "Patient List", path: "/admin/PatientList", match: "PatientList" },
        // { name: "Patient Records", path: "/admin/PatientRecords", match: "PatientRecords" },
      ]
    },
    { 
      name: "Provider Management", 
      icon: <FaUserNurse />, 
      path: "/admin/HCproviderList",
      match: "HCproviderList",
      subItems: [
        { name: "Provider List", path: "/admin/HCproviderList", match: "HCproviderList" },
        { name: "Provider Schedule", path: "#", match: "ProviderSchedule" },
      ]
    },
    { 
      name: "System Logs", 
      icon: <FaHistory />, 
      path: "/admin/AuditLogList",
      match: "AuditLogList",
      subItems: [
        { name: "Audit Logs", path: "/admin/AuditLogList", match: "AuditLogList" },
      ]
    }
  ];
  ...
  return (
    <>
      ...
      <Aside $mobileMenuOpen={mobileMenuOpen}>
        ...
        {user && (
          <UserProfile onClick={() => navigate('/admin/profile')}>
